...
Doorkeeper.configure do
  ...
  resource_owner_from_credentials do |_routes|
    if params[:scope] == 'coach'
      coach = Coach.find_for_database_authentication(email: params[:email])
      if coach&.valid_password?(params[:password])
  ...
  before_successful_strategy_response do |token, _request|
