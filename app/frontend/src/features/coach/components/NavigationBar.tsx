...
const NavigationBar = () => {
    ...
    return (
        <div className="flex flex-col items-center bg-[var(--color-secondary)] text-[var(--color-text-secondary)]">
            <Link to="/coach">
                <img 
...
const ButtonView = ({ children }: { children: React.ReactNode }) => (
    <div className="flex items-center w-[200px] font-semibold mb-5 ml-5 text-[var(--color-text-secondary)]">
      {children}
    </div>
);
...
const styledLinkClasses = "no-underline text-base font-semibold px-4 py-2 flex mt-5 hover:underline flex items-center gap-2";
